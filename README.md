...
Для текущей задачи Three.js идеален: он дает низкоуровневый контроль над геометрией, необходимый для построения стен и проемов "на лету". (также много готовых модулей к нему)
